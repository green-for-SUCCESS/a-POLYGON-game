...
- `src/rooms/BattleRoom.js`: an empty room handler for you to implement your logic
- `src/rooms/schema/BattleRoomState.js`: an empty schema used on your room's state.
